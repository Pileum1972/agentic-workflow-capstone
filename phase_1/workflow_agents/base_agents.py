        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": (
                    ...
                    "the steps requested to complete the action the user is asking for. You return the steps as "
                    "a list. Only return the steps in your knowledge. Forget any previous context. "
